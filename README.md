...
| 抖音 `www.douyin.com` | 首页上下滑 + 视频详情/评论 · 0.2.5 | [下载页](sites/douyin/) · [douyin.user.js](sites/douyin/douyin.user.js) |
...
- 详情页后退若落到「抖音精选电脑版」/ `/jingxuan` / `/`，改回 `/?recommend=1&from_nav=1` 并带上 `pcwtm`。菜单里点「精选」仍去精选
